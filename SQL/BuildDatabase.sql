...
DELIMITER //
CREATE PROCEDURE RemoveForeignKey(IN KeyToDelete VARCHAR(100))
  BEGIN
    DECLARE done INT DEFAULT FALSE;
    DECLARE TableName VARCHAR(100);
    DECLARE sqlString VARCHAR(200);
...
CREATE TABLE IF NOT EXISTS QuestionsPool
(
...
CREATE TABLE IF NOT EXISTS QuestionsPoolUsers
(
...
CREATE TABLE IF NOT EXISTS SectionUsers
(
...
CREATE TABLE IF NOT EXISTS InvitationReasons
(
	ReasonID VARCHAR(10),
...
CREATE TABLE IF NOT EXISTS CourseContentTemplates
(
...
CREATE TABLE IF NOT EXISTS AnswerableQuestionsGroups(
...
CREATE TABLE IF NOT EXISTS AnsweringQuestionsGroup(
...
CREATE TABLE IF NOT EXISTS AnswerableQuestions(
...
CREATE TABLE IF NOT EXISTS CourseContentChildren(
	ContentID BIGINT,
...
# CREATE TABLE IF NOT EXISTS RunningAssessments(
...
CREATE TABLE IF NOT EXISTS AnswerableQuestionsGroupTypes(
